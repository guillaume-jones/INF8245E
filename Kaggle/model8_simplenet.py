...
class Model(kt.HyperModel):
    ...
    def build(self, hyperparameters):
        ...
        output = self.conv_layer(output, 128, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, 2, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, 2, l2_reg=l2_reg, dropout=conv_dropout)
        output = self.conv_layer(output, 128, l2_reg=l2_reg, dropout=conv_dropout)
        ...
        output = self.dense_layer(output, 128, l2_reg=l2_reg, dropout=dense_dropout)
